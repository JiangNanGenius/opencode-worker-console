...
class ConsoleOwnerTests(unittest.TestCase):
    ...
    def test_console_exposes_safe_task_management_and_resilient_rendering(self):
        ...
        self.assertIn("const userDeletableStates = new Set([...terminalStates,'uncertain'])", app)
        self.assertIn('close_uncertain:true', app)
        self.assertIn('discard_unintegrated_worktrees:true', app)
