...
(function (global) {
  ...
  var MESSAGES = {
    en: {
      ...
      'quota.monthlyExhausted': 'Monthly plan exhausted. Remaining window allowance does not mean the model is available.',
    ...
    'zh-CN': {
      ...
      'quota.monthlyExhausted': '本月套餐总额度已耗尽，窗口显示剩余也暂时无法调用。',
    ...
    'zh-TW': {
      ...
      'quota.monthlyExhausted': '本月方案總額度已耗盡，即使視窗顯示剩餘也暫時無法呼叫。',
    ...
    ja: {
      ...
      'quota.monthlyExhausted': '月間プランの上限に達しました。利用枠に残量が表示されても、現在モデルは利用できません。',
    ...
    ko: {
      ...
      'quota.monthlyExhausted': '월간 요금제 한도에 도달했습니다. 사용 구간에 잔여량이 표시되어도 현재 모델을 사용할 수 없습니다.',
