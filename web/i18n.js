...
(function (global) {
  ...
  var MESSAGES = {
    en: {
      ...
      'tasks.deleteSelected': 'Delete selected', 'tasks.clearCompleted': 'Clear completed',
      ...
      'dialog.deleteTasks': 'Delete task entries', 'dialog.clearCompleted': 'Clear completed tasks',
      'dialog.deleteTasksHint': 'Delete {n} selected task entries? OpenCode sessions, workspaces and artifacts will be retained.',
      'dialog.clearCompletedHint': 'Remove all {n} completed task entries from this console? OpenCode sessions, workspaces and artifacts will be retained.',
    ...
    'zh-CN': {
      ...
      'tasks.deleteSelected': '删除所选', 'tasks.clearCompleted': '一键清理已完成',
      ...
      'dialog.deleteTasks': '删除任务记录', 'dialog.clearCompleted': '清理已完成任务',
      'dialog.deleteTasksHint': '确认删除所选的 {n} 条任务记录？OpenCode 会话、工作区和产物会保留。',
      'dialog.clearCompletedHint': '确认从控制台移除全部 {n} 条已完成任务？OpenCode 会话、工作区和产物会保留。',
    ...
    'zh-TW': {
      ...
      'tasks.deleteSelected': '刪除所選', 'tasks.clearCompleted': '一鍵清理已完成',
      ...
      'dialog.deleteTasks': '刪除任務記錄', 'dialog.clearCompleted': '清理已完成任務',
      'dialog.deleteTasksHint': '確認刪除所選的 {n} 條任務記錄？OpenCode 工作階段、工作區和產物會保留。',
      'dialog.clearCompletedHint': '確認從控制台移除全部 {n} 條已完成任務？OpenCode 工作階段、工作區和產物會保留。',
    ...
    ja: {
      ...
      'tasks.deleteSelected': '選択項目を削除', 'tasks.clearCompleted': '完了済みを一括削除',
      ...
      'dialog.deleteTasks': 'タスク記録を削除', 'dialog.clearCompleted': '完了済みタスクを一括削除',
      'dialog.deleteTasksHint': '選択した {n} 件のタスク記録を削除しますか？セッション、ワークスペース、成果物は保持されます。',
      'dialog.clearCompletedHint': '完了済みの {n} 件をコンソールから削除しますか？セッション、ワークスペース、成果物は保持されます。',
    ...
    ko: {
      ...
      'tasks.deleteSelected': '선택 항목 삭제', 'tasks.clearCompleted': '완료 작업 일괄 정리',
      ...
      'dialog.deleteTasks': '작업 기록 삭제', 'dialog.clearCompleted': '완료 작업 정리',
      'dialog.deleteTasksHint': '선택한 {n}개 작업 기록을 삭제할까요? 세션, 워크스페이스, 산출물은 유지됩니다.',
      'dialog.clearCompletedHint': '완료된 {n}개 작업 기록을 콘솔에서 삭제할까요? 세션, 워크스페이스, 산출물은 유지됩니다.',
